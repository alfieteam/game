...
if(isset($_POST['register'])){
	...
	if($username == "" || $password == "" || $email == ""){
		...
		if(mysqli_num_rows($register1) > 0){
			...
			$ins1 = mysqli_query(connect(),"INSERT INTO `stats` (`gold`,`attack`,`defense`,`food`,`income`,`farming`,`turns`) VALUES (100,0,0,100,10,11,0)") or die (mysqli_error());
			...
			$ins5 = mysqli_query(connect(),"INSERT INTO `ranking` (`attack`,`defense`,`overall`) VALUES (0,0,0)")or die(mysqli_error());
